...
<body>
	...
	class TamGiacDeu extends Hinh {
        ...
        public function tinh_DT() {
			$p = (3 * $this->dodai) / 2; 
            return round(sqrt($p * pow($p - $this->dodai, 3))*100)/100;
        }
    }
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="hinh" value="hv" 
                               <?php if (isset($_POST['hinh']) && $_POST['hinh'] == "hv") echo 'checked="checked"'; ?>/> Hình vuông
                        <input type="radio" name="hinh" value="ht" 
                               <?php if (isset($_POST['hinh']) && $_POST['hinh'] == "ht") echo 'checked="checked"'; ?>/> Hình tròn
						<input type="radio" name="hinh" value="tgd" 
                               <?php if (isset($_POST['hinh']) && $_POST['hinh'] == "tgd") echo 'checked="checked"'; ?>/> Tam giác đều
						<input type="radio" name="hinh" value="hcn" 
                               <?php if (isset($_POST['hinh']) && $_POST['hinh'] == "tgd") echo 'checked="checked"'; ?>/> Hình chữ nhật
                    </td>
                </tr>
                <tr>
                    <td>Nhập tên:</td>
